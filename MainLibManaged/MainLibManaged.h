...
namespace MainLibManaged 
{
    ...
    {
        CWordForm * m_pWordForm;

    public:
        CWordFormManaged(CWordForm *);
        ~CWordFormManaged();

        CLexemeManaged^ Lexeme();

        CWordForm * pGetUnmanagedItf();
...
//        EM_ReturnCode eGetAspectPair(String^%, int%, bool bIsVariant);
    ...
    public:
        ...
        CInflectionManaged();
        CInflectionManaged(CLexeme*);
        CInflectionManaged(CInflection*); // copy ctor
        ~CInflectionManaged();
...
//        EM_ReturnCode eCreateLexemeEnumerator(CLexemeEnumeratorManaged^%);
    ...
    */
    ...
    {
        Hlib::CLexemeEnumerator * m_pLexemeEnumerator;

    public:
        CLexemeEnumeratorManaged(CLexemeEnumerator *);
    ...
    {
        Hlib::CInflectionEnumerator * m_pInflectionEnumerator;

    public:
        CInflectionEnumeratorManaged(CInflectionEnumerator *);
        ~CInflectionEnumeratorManaged();

        EM_ReturnCode eReset();

        EM_ReturnCode eGetFirstInflection(CInflectionManaged^% pInflectionItf);
        EM_ReturnCode eGetNextInflection(CInflectionManaged^% pInflectionItf);
    };

    public ref class CParserManaged
    {
        Hlib::CParser * m_pParser;

    public:
        CParserManaged(CParser *);
        ~CParserManaged();
    ...
    {
        Hlib::CAnalytics* m_pAnalytics;

    public:
        CAnalyticsManaged(CAnalytics*);
        ~CAnalyticsManaged();
    ...
    {
        Hlib::CVerifier * m_pVerifier;

    public:
        CVerifierManaged(CVerifier *);
        ~CVerifierManaged();
